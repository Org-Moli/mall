...
import com.yq.service.goods.impl.GoodsService;
...
public class CartController extends BaseController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/cart/add", produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = "/cart/list", produces = "application/json;charset=UTF-8")
